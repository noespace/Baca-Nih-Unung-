...
const STORY_PAGES = [
  {
    ...
    body: `
      <p>Website ini dibuat karena setiap hari gue gatel banget mau ngomong sama lu, tapi setiap gue mulai mendekat, lu jutekin.</p>
      <p>Terus gue mundur. Terus kesel. Terus besoknya gatel lagi.</p>
      <div class="note">Siklusnya muter terus dan sangat tidak efisien.</div>
      <p>Jadi yaudah. Karena ngomong langsung susah, gue bikin beginian. Lagi.</p>
    `
  },
  {
    label: "02 — sebelumnya",
    ...
    body: `
      <p>Waktu itu gue negur lu karena menurut gue cara lu nagih Sisil kurang etis. Dibahas di grup dan diceletukin terus, sementara sebelumnya lu sendiri bilang santai aja.</p>
      ...
      <p>Dan sampai sekarang gue masih berpikir begitu.</p>
    `
  },
  {
    ...
    body: `
      <p>Gue juga enggak merasa diri gue paling bijaksana, paling bermoral, paling paham tata cara menagih utang, atau tiba-tiba turun dari langit membawa kitab etika pertemanan.</p>
      <div class="note pink"><strong>Gue ngomong karena lu temen gue.</strong></div>
      <p>Menurut gue, sebagai temen kita boleh saling ngingetin kalau ada sesuatu yang terasa kurang pas. Lu juga boleh melakukan hal yang sama ke gue.</p>
      <p>Yang gue komentarin waktu itu adalah <strong>satu tindakan lu pada satu kejadian.</strong></p>
      <p>Bukan seluruh kepribadian lu. Bukan keseluruhan sejarah pertemanan kita. Dan apalagi bukan pengumuman bahwa selama ini gue enggak nyaman main sama lu.</p>
    `
  },
  {
    label: "04 — kesalahan penerjemahan",
    title: "TERUS LU KOK LOMPATNYA JAUH BANGET?",
    body: `
      <p>Dari:</p>
      ...
      <p>Gimana ceritanya satu kegelisahan langsung berubah menjadi pemutusan hubungan pertemanan?</p>
      <p><strong>GASEMUA ORANG YANG MENGUNGKAPKAN PERASAAN ARTINYA GAMAU MAIN LAGI, WOY.</strong></p>
      <p>Kalau gue memang sudah enggak nyaman atau enggak srek sama lu, gue enggak akan repot-repot ngomong sepanjang ini. Gue tinggal <em>dor</em> dari kehidupan gue.</p>
      <p>Tapi kan enggak. Gue masih di sini.</p>
      <div class="note">Bahkan bikin website lagi. Tolong dihargai kegilaan saya.</div>
    `
  },
  {
    ...
    body: `
      ...
      <p>Kayak pertemanan kita enggak boleh punya gesekan sedikit pun. Sekali ada yang ngomong, langsung dianggap sudah tidak nyaman, tidak sefrekuensi, dan lebih baik selesai.</p>
      <p>Padahal gue enggak sedang minta kita selesai.</p>
      <p>Gue cuma lagi ngajak lu berhenti sebentar dan mikir, “Eh, mungkin bagian ini bisa kita lihat lagi.”</p>
      <p>Udah. Itu doang.</p>
      <div class="note pink">Enggak ada agenda rahasia penggulingan pemerintahan Khusnul Khotimah.</div>
    `
  },
  {
    ...
    body: `
      ...
      <p>Gue enggak pernah memutuskan bahwa gara-gara kejadian itu kita jadi enggak cocok. Itu kesimpulan yang lu buat sendiri, terus lu tempelkan ke kepala gue.</p>
      <div class="note"><strong>Kepala gue menolak.</strong></div>
    `
  },
  {
    ...
    body: `
      ...
      <p>Gue menyayangi lu seperti teman kandung. Bahkan nyaman seperti di dalam rahim ibu.</p>
  ...
  },
  {
    ...
    body: `
      ...
      <div class="note"><strong>Itu bukan maksud gue.</strong></div>
      <p>Gue enggak sedang menempatkan diri sebagai orang yang lebih baik dari lu. Gue cuma Aliefi yang waktu itu merasa ada sesuatu yang perlu disampaikan ke temennya.</p>
      ...
      <p>Kita enggak harus punya isi kepala yang sama persis untuk tetap bisa duduk bareng, makan, karaoke, terus pulang sambil ngomongin orang—eh.</p>
    `
  },
  {
    label: "09 — terakhir",
    title: "DARI SISI GUE, PINTUNYA ENGGAK PERNAH DITUTUP.",
    body: `
      <p>Gue tahu gue enggak bisa maksa lu untuk tetap berteman sama gue.</p>
      ...
      <div class="big-text">Enak aja. Minimal rapat dulu. Kuorum dulu.</div>
